...
abstract class swipecontrollerdemo(context: Context?, status: LiveData<Boolean>?) : ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT) {

    private val deleteIcon = context?.let { ContextCompat.getDrawable(it, R.drawable.ic_delete_white_24dp) }
